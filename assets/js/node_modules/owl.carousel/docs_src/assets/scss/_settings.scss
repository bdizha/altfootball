...
// $blockquote-padding: rem-calc(9 20 1 19);
 $blockquote-border: 7px solid #ddd;
...
// $input-font-color: rgba(0, 8, 39,0.75);
...
// $input-box-shadow: inset 0 1px 2px rgba(0, 8, 39,0.1);
...
// $joyride-screenfill: rgba(0, 8, 39,0.5);
...
// $orbit-nav-bg-hover: rgba(0, 8, 39,0.3);
...
// $orbit-slide-number-bg: rgba(0, 8, 39,0);
...
$side-nav-list-margin: rem-calc(0);

// We use these to control link styles.
$side-nav-link-color: #8A9191;
// $side-nav-link-color-active: scale-color($side-nav-link-color, $lightness: 30%);
$side-nav-link-color-hover: #000;//scale-color($side-nav-link-color, $lightness: 30%);
...
// $split-button-active-bg-tint: rgba(0, 8, 39,0.1);
