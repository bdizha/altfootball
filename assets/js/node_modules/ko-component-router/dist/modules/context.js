...
import { isGenerator, isPlainObject, isThenable, isUndefined, concat, extend, map, promisify, sequence } from './utils';
        ...
        return isGenerator(fn)
            ...
            : function (ctx) {
                return tslib_1.__asyncGenerator(this, arguments, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, tslib_1.__await(promisify(fn)(ctx))];
                            case 1:
                                ret = _a.sent();
