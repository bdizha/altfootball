<template id="post-template">
    <div class="p32Iu" data-bind="css: { active: isShowing }">
        <div class="_3bxb0">
            ...
            <div class="_4TYO">
                <a class="_2hvwD" data-bind="attr: { 'href': '/p/' + post().slug }, click: showPost">
                    <div class="_25bvT">
                ...
                <h3 class="_35O2p _3VB1o _3duUm _2L6V9">
                    <span>
                        ...
                        <a class="_1kgtA _2Oo2A" data-bind="attr: { href: '/p/' + post().slug }, text: post().reading_time, click: showPost"></a>
