        ...
        <div class="sc-gxMtzJ ljjFes">
            ...
            <div class="sc-eXEjpC gESGAG" data-reactid="183">
                <div class="sc-ibxdXY hKmwtp" data-reactid="184">
                    <a class="_38L6D" data-bind="attr: { href: '/p/' + post.slug }">
                        <figure class="filter">
                            <img role="presentation" class="_HGT78" data-bind="attr: { src: post.thumb_x, alt: post.title }">
                            <img role="presentation" class="_HGT79" data-bind="attr: { src: post.small_x, alt: post.title }">
                        </figure>
                    </a>
                </div>
            </div>
            <div class="sc-dfVpRl bcqOPV">
                ...
                <a class="sc-kIPQKe jzIbtI" data-bind="attr: { href: '/p/' + post.slug }, html: post.summary_x"></a>
                <div class="sc-gzOgki eetbSx">
                    <button class="sc-gxMtzJ gwBfwM" data-tracking="post - bump - add">
                        <div class="_1_VaP">
                            ...
                            <span class="sc-dfVpRl lkOqlM">37</span>
                        </div>
                    </button>
                    <button class="sc-gxMtzJ gwBfwM" data-tracking="post - bump - add">
                        <div class="_1_VaP">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" version="1.1" width="24" height="24">
                                <g class="style-scope yt-icon">
                                    <path fill="rgba(51, 74, 108, 0.75)" d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4z" class="style-scope yt-icon"></path>
                                </g>
                            </svg>
                            <span class="sc-dfVpRl lkOqlM">37</span>
                        </div>
