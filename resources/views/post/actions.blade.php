<div class="sc-gzOgki eetbSx">
    <button class="sc-gxMtzJ gwBfwM" data-tracking="post - bump - add">
        <a class="_1_VaP" href="{{ route('post.show', ['slug' => $post->slug]) }}#tackles">
            <div class="_TYRW3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" version="1.1"  width="22px" height="22px" class="_3gymQ">
    ...
    <button class="sc-gxMtzJ gwBfwM" data-tracking="post - bump - add">
        <div class="_1_VaP">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" version="1.1" width="22px" height="22px">
    ...
    <button class="sc-gxMtzJ gwBfwM" data-tracking="post - bump - add">
        <div class="_1_VaP">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
                ...
                <g id="surface1">
                    <path style=" fill:rgba(51, 74, 108, 0.75);"
