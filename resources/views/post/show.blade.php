                                    ...
                                    <div class="_3PwOQ sc-jTzLTM kGoDGv">
                                        <div class="sc-fjdhpX dAAOAM">
                                            <div class="_38L6D" style="padding-bottom: 100%;">
                                                <img alt="" role="presentation" src="{{ $post->user->thumb_x }}" class="_214e9 b00q8" width="60" height="60">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="_2xoE4 NasRD _3QYjF">
                    <button class="_1Zj5n _1cG70 _2YLzg">
                        <svg width="10" height="10">
                            <path fill="none" stroke="rgba(103, 143, 185, 0.95)" stroke-linecap="square" stroke-width="2"
