                ...
                <div class="sc-gMcBNU bVsJja">
                    <div class="sc-dYzWWc fZBlIg">
                        <div class="sc-iLVFha efawYm _1KXFt">
                            <div class="_23p6h">
                                <img src="{{ $fanbase->thumb_x }}" role="presentation" alt="" class="_2PoG-" width="165"
                                ...
                                <div>
                                    ...
                                    <div class="sc-bYnzgO lbyJvT">
                                        ...
                                        <div class="sc-fvLVrH duDvju sc-fCPvlr hGwjDc"><span class="sc-gAmQfK hKaISF"><a
                                                        class="" href="/u/{{ $fanbase->user->slug }}/members"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="18" height="14"
                                                            viewBox="0 0 18 14" class="sc-cCVOAp eVkXGE"><path fill="rgb(0, 50, 75)"
                                                                fill-rule="evenodd"
                                            ...
                                            <span class="sc-gAmQfK ffPLas"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="18" height="15"
                                                                                viewBox="0 0 18 15"
                                                                                class="sc-cfWELz eqSeMm"><g fill="none"
                            ...
                            <div class="sc-iHhHRJ hLRQek">
                                <section class="sc-dXfzlN glYIFw">
                                    <div class="sc-isBZXS cvlUzR">
                                        ...
                                        <a class="sc-aewfc bCHmiu" href="/u/{{ $fanbase->user->slug }}">
                                            ...
                                            <span class="sc-jHZirH glCfih">{{ $fanbase->user->name }}</span>
                                        </a>
                                    </div>
                                </section>
                                <section class="sc-dXfzlN glYIFw">
                                        ...
                                        <span class="sc-gAmQfK hKaISF">
                                            <a class="" href="/u/{{ $fanbase->user->slug }}/members">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14"
                                                    ...
                                                    <path fill="rgb(0, 50, 75)" fill-rule="evenodd"
                                                          d="M6.7 1.5C8 1.5 9 2.5 9 4c0 1.3-1 2.4-2.3 2.4-1.4 0-2.5-1-2.5-2.4s1-2.5 2.5-2.5M9.2 7c1-.7 1.4-1.8 1.4-3 0-2.2-1.8-4-4-4-2 0-4 1.8-4 4 0 1.2.7 2.3 1.5 3-2 1-3.5 3-4 5.8 0 .4.2.8.6.8.4 0 .8-.2 1-.6.4-3 2.6-5 5-5 2.5 0 4.7 2 5.2 5 0 .4.4.7.8.7.5 0 .8-.5.7-1-.5-2.6-2-4.7-4-5.7m4.8 0c.6-.8 1-1.7 1-2.7 0-2.2-1.8-4-4-4-.5 0-.8.4-.8.8 0 .5.3 1 .8 1 1.3 0 2.4 1 2.4 2.3 0 1-.4 1.7-1.2 2.2-.4.2-.5.6-.3 1 .3.2.5.4.8.4 1.8.5 3.3 2.4 3.7 4.6 0 .4.4.6.7.6h.2c.4 0 .7-.4.6-.8C17.5 10 16 8 14.2 7"></path>
                                                </svg>
                                                129.2K
                                            </a>
                                        </span>
                                        <span class="sc-gAmQfK ffPLas">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15"
                                                 viewBox="0 0 18 15" class="sc-cfWELz eqSeMm">
                                                <g fill="none" fill-rule="evenodd">
                                                    <path fill="#FFF"
                                                          d="M11.31 7.16a2.4 2.4 0 1 1-4.78 0 2.4 2.4 0 0 1 4.78 0"></path>
                                                    <path fill="rgb(0, 50, 75)"
                ...
                <div class="sc-izvnbC ZnxSI">
                    ...
                    <div class="sc-dPPMrM bJPofi">
                        <div class="sc-rBLzX SsCsq">
                            <div class="sc-imABML hnPypn">
                                <a class="sc-iNhVCk gKdjnO" href="/t/brians-garage-RE9ZAby3RFODwUEP4z5KKA">Stories</a>
                                <a class="sc-eAKXzc gXKEdt" href="/t/brians-garage-RE9ZAby3RFODwUEP4z5KKA/chat">Chat</a>
                                <button class="sc-jdfcpN kMqLaL">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="3" viewBox="0 0 18 3">
