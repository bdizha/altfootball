        ...
        <div class="_344b1 _5X5FD">
            ...
            <div data-bind="css: { '_45-A3': selected() == 'one' }">
                <div class="_1Q_Pu">
                    ...
                    <p class="C8E2s"><span><span>This document sets out the Community Guidelines that applies to your use of ALTFOOTBALL and any videos, photographs, message or any other content that you may upload (“Content”) and the Original Content.</span></span>
                    </p>
                    <p class="C8E2s"><span><span>“Original Content" is the videos and other content posted by or created by us (ALTFOOTBALL Limited) our directors and employees, and our group companies, including but not limited to content featuring our presenters, including Jeremy Clarkson, James May and/or Richard Hammond. Original Content may only be shared within ALTFOOTBALL or via other social media platforms as part of the sharing functionality on ALTFOOTBALL. Original Content may not be independently downloaded, copied, streamed, broadcast or otherwise used without our prior written consent.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>Just don’t.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>1.1.6. suggest any endorsement by us or any of our presenters, including Jeremy Clarkson, James May or Richard Hammond.</span></span>
                    </p>
                    <h3 class="_1PQQ2"><span><span>2. USE OF ORIGINAL CONTENT AND USERS’ CONTENT</span></span></h3>
                    <p class="C8E2s"><span><span>2.1. You may only use and watch Original Content and users’ Content uploaded onto ALTFOOTBALL by as permitted by us. You may watch, view and stream Original Content and users’ Content on the ALTFOOTBALL website and apps. You may also share Original Content and users’ Content using the ALTFOOTBALL social media sharing functionality and by linking to the ALTFOOTBALL video page using the functionality made available by us.</span></span>
                    </p>
                    <p class="C8E2s"><span><span>2.2. You may not copy, download, or embed any Original Content or users’ Content without the express written permission of the content owner.</span></span>
                    </p>
                    <p class="C8E2s"><span><span>2.3. You may not embed the ALTFOOTBALL video player in any other website.</span></span>
                    </p>
                    <p class="C8E2s"><span><span>2.4. You may not use any Original Content or other users’ Content for any commercial purposes, or any public performances.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>3.2. You shall not use or set up an account to imposter any other person, or to set up fake or ‘bot’ style accounts.</span></span>
                    </p>
        ...
        <div class="_344b1 mv9zs">
            ...
            <div data-bind="css: { '_45-A3': selected() == 'two' }">
                <div class="_1Q_Pu">
                    ...
                    <p class="C8E2s"><span><span>The following Terms of Use “(Terms of Use”) apply to all use, download and installation of the ALTFOOTBALL website and apps (”ALTFOOTBALL”) as made available by ALTFOOTBALL Limited.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>1.1. ALTFOOTBALL is owned and operated by ALTFOOTBALL Limited, referred to as “us”, “we”, and “our” in these Terms of Use. We are a company registered in England, with our registered office at Eastside, Kings Cross, London, N1C 4AX. </span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>4.3. We retain and reserve all rights in the videos and other content posted by us, our directors and employees (“Original Content”), including but not limited to content created by us or any of our group companies or featuring our presenters, including Jeremy Clarkson, James May and Richard Hammond. Original Content may be viewed by you on ALTFOOTBALL and shared using the social media functionality made available on ALTFOOTBALL. You may not copy, broadcast or use the Original Content for any other purposes without our prior written consent. All our rights on the Original Content are reserved by us.</span></span>
                    </p>
                    <h3 class="_1PQQ2"><span><span>5. HOW WE USE YOUR UPLOADED CONTENT  (I.E VIDEOS, PHOTOS, COMMENTS ETC)</span></span></h3>
                    <p class="C8E2s"><span><span>5.1. As an account holder, you may upload video content, photographs and other content to ALTFOOTBALL (“Content”).</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>7.1. Where we make available links to other websites or apps through ALTFOOTBALL, such links are provided for your information and convenience only. We are not responsible for the content or performance of the linked website or app, and you are responsible for reviewing the linked website’s or app’s Terms of Use.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>8.4. By installing or using any apps distributed as part of ALTFOOTBALL (“App” below) on iOS you agree that these terms (which we are required by Apple to incorporate) shall apply:</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>8.4.7. Third Party Beneficiary: You acknowledge and agree that Apple, and Apple’s subsidiaries, are third party  beneficiaries of these Terms of Use, and that when you accept the Terms of Use of these Terms of Use, Apple will have the right (and will be deemed to have accepted the right) to enforce these Terms of Use against you.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>14.1 ALTFOOTBALL is provided ‘AS IS’ and on an ‘AS AVAILABLE’ basis without any representation, endorsement or warranty of any kind OTHER THAN THAT IT WILL BE OF SATISFACTORY QUALITY, AS DESCRIBED, AND FIT FOR PURPOSE.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>14.8. our ENTIRE LIABILITY TO YOU, and to the extent we can not exclude it, WHERE PERMISSIBLE BY LAW, SHALL BE LIMITED TO £100.</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>16.1. “ALTFOOTBALL” is an unregistered mark used by us, and all rights are reserved by us.</span></span>
                    </p>
        ...
        <div class="_344b1 ZxFDK">
            ...
            <div data-bind="css: { '_45-A3': selected() == 'three' }">
                <div class="_1Q_Pu">
                    ...
                    <p class="C8E2s"><span><span>The following privacy and cookies policy (“Privacy Policy”) sets out how we use data relating to you and applies to all use of your personal information by ALTFOOTBALL Limited, a company registered in England, with its registered office at Eastside, Kings Cross, London, N1C 4AX (“ALTFOOTBALL”, “we”, “us” and “our”). </span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>1.1. Data you supply (“Submitted Information”) includes:</span></span>
                    </p>
                    ...
                    <p class="C8E2s"><span><span>1.2.1. We may monitor your use of our Service through cookies and similar tracking technologies. For example, we may monitor how many times you visit, which pages you go to and which videos you watch, traffic data, your IP and MAC address, a unique device identifier, the browsers and devices you use to access our Service, your internet service provider, and the actions you take when using our Service (“Analytics”).</span></span>
                    </p>
