                    ...
                    <div class="logo">
                        <div class="icons">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="square" viewBox="0 0 26 26" version="1.1" width="44px" height="44px">
                                <g id="surface1">
                                    <path style="fill: #FFFFFF;" d="M 21.125 2 L 4.875 2 C 2.183594 2 0 4.183594 0 6.875 L 0 19.125 C 0 21.816406 2.183594 24 4.875 24 L 21.125 24 C 23.816406 24 26 21.816406 26 19.125 L 26 6.875 C 26 4.183594 23.816406 2 21.125 2 Z "/>
                                </g>
                            </svg>
            ...
            @if(Auth::guard()->check() && Auth::user()->is_active)
                ...
                <button class="_13sKJ">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 16 18" class="_8e7Ip">
                        <g fill="none" fill-rule="evenodd" stroke="rgba(51, 74, 108, 0.65)" stroke-linecap="round"
