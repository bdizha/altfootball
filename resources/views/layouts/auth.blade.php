                ...
                <div class="_1A3CD" data-bind="css: { active: shouldShowJoinPopup }">
                    <header class="_3XXLi">
                                ...
                                <form class="ra77F" action="" data-reactid="18">
                                    <div class="_1YqNB _1eF7g _3TYH2" data-reactid="19">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                             viewBox="0 0 40 42" class="_2-OFE _1_FTk _3ZPAz" data-reactid="21">
                        ...
                        <div class="_3GUPV -hkpO" data-reactid="28" style="transform: scaleY(0) translateZ(0px);">
                            <div class="_2Ruh1" data-reactid="29"
                                 style="opacity: 0; transform: translateY(-75px) translateZ(-40px);">
                                <nav class="_3GkHt _3AKLf" data-reactid="30">
                                    <button class="zxDoM undefined" data-reactid="31"><!-- react-text: 32 -->Activity
                                        <!-- /react-text --><!-- react-empty: 33 --></button>
                                    <button class="_3UwsA zxDoM" data-reactid="34"><!-- react-text: 35 -->Invites
                                        <!-- /react-text --><!-- react-empty: 36 --></button>
                                </nav>
                                <div class="_1ese_" data-reactid="37">
                                    <div data-reactid="38">
                                        <ul class="_3XxoM" data-reactid="39"></ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="_BrFp" data-reactid="40"></div>
                    </header>
                    <div class="container">
