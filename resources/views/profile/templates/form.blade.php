                ...
                <div class="_3C1Cx">
                    <button class="_1ozur" data-bind="click: closeEditForm">
                        <svg width="24" height="24" viewBox="0 0 18 18">
                            <g stroke="rgba(125, 160, 177, 0.65)" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="square">
                            ...
                            <label for="profile-image-upload">
                                <div class="_21web">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" class="_2vslu">
                                        <g fill="none" fill-rule="evenodd" stroke="rgba(125, 160, 177, 0.65)">
