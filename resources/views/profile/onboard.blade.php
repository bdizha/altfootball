                    ...
                    <div class="_1KQuz">
                        <h3 class="_2o06m _1oBl0">
                            <span class="_1QEWe">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 18 18" class="_1z7Hy aX-51"><g fill="none" fill-rule="evenodd"><path fill="rgba(69, 193, 78, 1)" d="M0 9a9 9 0 1 0 18 0A9 9 0 0 0 0 9z"></path><path fill="rgba(255, 255, 255, 1)" d="M12.38 5.17l1.58 1.58-6.09 6.08L4.04 9l1.58-1.58 2.25 2.25"></path></g></svg>
                            </span>
                        </h3>
